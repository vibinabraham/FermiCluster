...
def test_2():
    ...
    ci_vector = ClusteredState(clusters)
    if orb_basis == 'scf':
        ci_vector.init(((2,2),(2,2),(1,1),(0,0)))
        ci_vector.add_fockspace(((2,2),(2,1),(1,2),(0,0)))
        ci_vector.add_fockspace(((2,2),(1,2),(2,1),(0,0)))
        ci_vector.add_fockspace(((2,2),(2,2),(1,0),(0,1)))
        ci_vector.add_fockspace(((2,2),(2,2),(0,1),(1,0)))
        ci_vector.add_fockspace(((2,2),(2,2),(0,0),(1,1)))
