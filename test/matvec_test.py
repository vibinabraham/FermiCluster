...
# {{{
    ...
    out_vector7 = matvec1_parallel5(clustered_ham, ci_vector).get_vector()
   
    for vi in range(len(out_vector1)):
        print(" %12.8f %12.8f %12.8f  %12.8f  %12.8f  %12.8f " %(out_vector1[vi],out_vector2[vi],out_vector3[vi],out_vector4[vi],out_vector5[vi],out_vector6[vi],out_vector7[vi]))
        ...
        assert(abs(out_vector1[vi]-out_vector7[vi]) < 1e-8)
