...
h,g,ecore = init_pyscf(molecule,charge,spin,basis_set,orb_basis,cas_nstart=0,cas_nstop=7,cas_nel=10,cas=True)

#cluster using hcore
idx = e1_order(h,cut_off = 0.4)
